...
private extension NetworkErrorUserMessageTests {
    static let requestCreationMessage = "We could not create the request."
    static let invalidResponseMessage = "The server returned an invalid response."
    static let unauthorizedMessage = "You are not authorised to perform this action."
    static let rateLimitMessage = "Too many requests. Please try again in a moment."
    static let serverUnavailableMessage = "The server is currently unavailable. Please try again shortly."
    static let genericFailureMessage = "Something went wrong while loading data."
    static let noConnectionMessage = "Please check your internet connection and try again."
    static let decodingFailureMessage = "We could not read the server response."
    static let unknownFailureMessage = "Something unexpected happened. Please try again."

    static func assertMessage(_ error: NetworkError, equals expected: String) {
